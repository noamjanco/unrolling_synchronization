...
class CompareSO3UnrollingRuntimeExperiment(Experiment):
...
if __name__ == '__main__':
    CompareSO3UnrollingRuntimeExperiment(params={'N': 20, 'R': 10000, 'num_trials': 1, 'depth_range': [9], 'epochs': 100, 'Lambda': 1.5})
