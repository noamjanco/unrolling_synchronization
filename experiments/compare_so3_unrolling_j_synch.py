...
def task(N, R, Lambda, DEPTH, seed, epochs):
    ...
    s_val, Y_val = generate_training_data_so3_with_j_ambiguity(N,Lambda,R)
...
if __name__ == '__main__':
    ...
    CompareSO3UnrollingJSynchExperiment(params={'N': 20, 'R': 10000, 'num_trials': 1, 'depth_range': [9], 'epochs': 100, 'Lambda': 2.})
